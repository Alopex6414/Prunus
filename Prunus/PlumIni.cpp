...
//-----------------------------------------------------------------------------------------------------------------------------------
bool PLUMINI_CALLMETHOD CPlumIni::PlumIniReadStringKeyValue(char* pStrFileName, char* pStrSection, char* pStrKey, char* pStrDefault, char** ppStrValue)
{
	bool bResult = false;
...
// @Return: bool				//布尔型 true:成功 false:失败
//----------------------------------------------------------------------------------------------------------------------
bool PLUMINI_CALLMETHOD CPlumIni::PlumIniReadIntKeyValue(char* pStrFileName, char* pStrSection, char* pStrKey, int nDefault, int* pValue)
{
	bool bResult = false;
	char** ppArray = NULL;
...
// @Return: bool				//布尔型 true:成功 false:失败
//-----------------------------------------------------------------------------------------------------------------------------------
bool PLUMINI_CALLMETHOD CPlumIni::PlumIniWriteStringKeyValue(char* pStrFileName, char* pStrSection, char* pStrKey, char* pStrValue)
{
	bool bResult = false;
	DWORD dwCount = 0;
...
// @Return: bool				//布尔型 true:成功 false:失败
//-----------------------------------------------------------------------------------------------------------------------------------
bool PLUMINI_CALLMETHOD CPlumIni::PlumIniWriteIntKeyValue(char* pStrFileName, char* pStrSection, char* pStrKey, int nValue)
{
	bool bResult = false;
	char strValue[32];
