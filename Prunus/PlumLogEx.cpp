...
//------------------------------------------------------------------
// @Function:	 PlumLogExWrite()
// @Purpose: CPlumLogEx写入日志
// @Since: v1.00a
// @Para: None
// @Return: None
//------------------------------------------------------------------
void PLUMLOGEX_CALLMETHOD CPlumLogEx::PlumLogExWrite(LPCSTR lpcstr, ...)
{
	...
	PlumLogExGetLogFilePath(chLogFile, MAX_PATH);

	if (!PathFileExistsA(chLogFile))
	{
		PlumLogExCreateLogFilePath();
	}
...
//------------------------------------------------------------------
// @Function:	 PlumLogExWriteLine()
// @Purpose: CPlumLogEx写入日志换行
// @Since: v1.00a
// @Para: None
// @Return: None
//------------------------------------------------------------------
...
//------------------------------------------------------------------
// @Function:	 PlumLogExCreateLogFilePath()
// @Purpose: CPlumLogEx创建日志文件路径
// @Since: v1.00a
// @Para: None
// @Return: None
//------------------------------------------------------------------
void PLUMLOGEX_CALLMETHOD CPlumLogEx::PlumLogExCreateLogFilePath()
{
	...
	PlumLogExGetComputerName();
	PlumLogExGetUserName();
	PlumLogExGetWindowsVersion();
...
//------------------------------------------------------------------
// @Function:	 PlumLogExGetLogFilePath()
// @Purpose: CPlumLogEx获取日志文件路径
// @Since: v1.00a
// @Para: None
// @Return: None
//------------------------------------------------------------------
void PLUMLOGEX_CALLMETHOD CPlumLogEx::PlumLogExGetLogFilePath(char* pStr, int nSize)
{
...
//------------------------------------------------------------------
// @Function:	 PlumLogExGetComputerName()
// @Purpose: CPlumLogEx获取计算机名称
// @Since: v1.00a
// @Para: None
// @Return: None
//------------------------------------------------------------------
void PLUMLOGEX_CALLMETHOD CPlumLogEx::PlumLogExGetComputerName()
{
...
//------------------------------------------------------------------
// @Function:	 PlumLogExGetUserName()
// @Purpose: CPlumLogEx获取用户名称
// @Since: v1.00a
// @Para: None
// @Return: None
//------------------------------------------------------------------
void PLUMLOGEX_CALLMETHOD CPlumLogEx::PlumLogExGetUserName()
{
...
//------------------------------------------------------------------
// @Function:	 PlumLogExGetWindowsVersion()
// @Purpose: CPlumLogEx获取Windows版本名称
// @Since: v1.00a
// @Para: None
// @Return: None
//------------------------------------------------------------------
void PLUMLOGEX_CALLMETHOD CPlumLogEx::PlumLogExGetWindowsVersion()
{
